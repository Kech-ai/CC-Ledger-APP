...
const Icon: React.FC<{ icon: string }> = ({ icon }) => {
    const icons: { [key: string]: React.ReactNode } = {
        ...
        journal: <>
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 7l7 4 7-4" />
        </>,
        reports: <>
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19v-10a2 2 0 00-2-2h-2a2 2 0 00-2 2v10a2 2 0 002 2h2a2 2 0 002-2z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 19V5a2 2 0 00-2-2h-2a2 2 0 00-2 2v14a2 2 0 002 2h2a2 2 0 002-2z" />
        </>,
        settings: <>
